...
#   end
#
#   # (["/path/foo.jpg"], :thread) -> [{"/path/foo.jpg", :thread, 2048}]
...
#           [{f, user, size} | acc]
#         {:error, reason} ->
#           Logger.warn "Error reading #{f}: #{reason}"
#           acc
#       end
#
#       {f, user, 
#       dir = [@image_output_dir, Atom.to_string(user)] |> Path.join
#
#       File.mkdir!(dir)
#
#       do_resize_big(f, "2000x2000",
#       open(f) |> copy |> resize_to_limit("2000x2000") |> save(file)
#     end
#   end
#
